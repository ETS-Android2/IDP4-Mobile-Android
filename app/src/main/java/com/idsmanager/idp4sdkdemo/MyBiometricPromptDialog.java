...
import com.idsmanager.verificationtypelibrary.biometric.service.OnBiometricPromptDialogActionService;
 ...
 */
public class MyBiometricPromptDialog extends DialogFragment implements BiometricPromptDialogService {

    private TextView mStateTv;
    private TextView mUsePasswordBtn;
    private TextView mCancelBtn;
    private Activity mActivity;
    private OnBiometricPromptDialogActionService mDialogActionCallback;


    public void setOnBiometricPromptDialogActionCallback(OnBiometricPromptDialogActionService callback) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_my_biometric_prompt_dialog, container);
